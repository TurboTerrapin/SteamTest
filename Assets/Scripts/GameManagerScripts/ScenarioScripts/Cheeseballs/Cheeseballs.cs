/*
    Cheeseballs.cs
    - Spawns a bunch of cheeseballs that do nothing
...
public class Cheeseballs : NetworkBehaviour, IScenario
{
    //CLASS CONSTANTS
    private static int CHEESEBALL_QUANTITY = 100;
    ...
    public void initiateScenario()
    {
        ...
        for (int i = 0; i < CHEESEBALL_QUANTITY; i++)
        {
            ...
            curr_cheeseball.name = "Cheeseball";
